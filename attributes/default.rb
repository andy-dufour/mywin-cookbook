default['notepadpp']['url'] = 'https://s3-eu-west-1.amazonaws.com/apop-bucket/npp.6.7.4.Installer.exe'
# checksum obtained by running on a CentOS machine: sha256sum npp.6.7.4.Installer.exe
default['notepadpp']['checksum'] = 'ad80a9458c2732e5113a1f1cd5dd51f1656fda875c094ca9467b89ebfe1c3c43'
